class Youtube {
    ...
    getTitle = ()=>{
     ...
     let y1:Youtube = new Youtube("Powerstar pawan kalyan Biggest Movie name is GabbarSing"," This Movie build by Parameswara Art Productions","This movie lot of factors like Action and Entertainer movie",
     "This Movie Published by on of the tollywood biggest Screen  Mythri move makers","This mobie views in 100.2millions",5123564782,100,200000,"3000k","500000k")
